      ...
      <div className=" flex items-center justify-between h-20 w-full bg-white shadow-2xl px-9 ">
        ...
        <div className=" font-semibold">
          <ul className="flex items-center justify-between gap-16 text-gray-600">
            ...
            <li>
              <Link>
                <div className="flex items-center gap-3 relative">
                  ...
                  <span>Offers</span>
                  <span className=" text-orange-500 absolute -top-3 -right-7 text-sm ">
                    New
                  </span>
                </div>
              </Link>
            ...
            <li>
              <Link>
                <button onClick={() => setSignInModel(true)}>
                  <div className=" flex gap-3 items-center">
                    <span className="_3yZyp">
                      <svg
                        className="_1GTCc"
            ...
            <li>
              <Link>
                <div className=" relative">
                  <div>
                    <div className="flex items-center gap-3 relative">
                      <span className=" absolute right-9 top-">
                        <svg
                          className=""
                          viewBox="-1 0 37 32"
                          height="26"
                        ...
                        <span className=" absolute right-[7px] top-0">0</span>
                      </span>
                      <span>Cart</span>
                    </div>
                  </div>
